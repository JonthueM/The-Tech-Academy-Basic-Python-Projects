...
def load_gui(self):
    ...
    self.btn_browseOne = tk.Button(self.master,width=13, height=2, text='Browse...', command=lambda:func.getDir(self))
    self.btn_browseOne.grid(row=2, column=0,padx=(1,0), pady=(20,10))
    self.btn_browseTwo = tk.Button(self.master,width=13, height=2, text='Browse...', command=lambda:func.getDir2(self))
